...
lcinfile = '/group/belle2/users2022/dhettiar/ntuples/MC/lcp/weights/pkpi_ppipi_weighted.root'
dinfile = '/group/belle2/users2022/dhettiar/ntuples/MC/d/k3pi_ppipi_625.root'
...
s1 = zfit.param.Parameter("s1", 0.005, 0.0001, 0.02)
s2 = zfit.param.Parameter("s2", 0.005, 0.0001, 0.02)
...
sig_yield = zfit.Parameter('sig_yield', 1000000, 0, 1e9, step_size=1)
bkg_yield = zfit.Parameter('bkg_yield', 4000000, 0, 1e9, step_size=1)
...
path = "/group/belle2/users2022/dhettiar/ntuples/MC/d/weights/k3pi_ppipi_weighted.root"
