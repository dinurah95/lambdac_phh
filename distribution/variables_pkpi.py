...
lambda_c = "/group/belle2/users2022/dhettiar/ntuples/MC/lcp/pkpi_dis.root"
...
c_v_2 =['Lambdac_p_cms','Lambdac_flightDistance','Lambdac_significanceOfDistance','p_trinaryID','p_p','pi_p','K_binaryID']
...
df_lam = root_pandas.read_root(lambda_c, key='lcp_pkpi', columns=columns, where=Loading_cut) 
...
mass_plot_all_Stack(var='Lambdac_M',
           ...
           myXlabel=r'$\Lambda_c$ Mass ($\Lambda_c^+\to p^+ K^- \pi^+$) [GeV/$c^2$]', mylog=False)
...
get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.7 < K_binaryID                     & 0 < Lambdac_flightDistance                      & 0.9 < p_trinaryID                     & 2.5 < Lambdac_p_cms                    & 4.0 > pi_p                    & 5.0 > p_p')
...
get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.7 < K_binaryID                     & 0 < Lambdac_flightDistance                      & 0.25 < Lambdac_significanceOfDistance                     & 0.9 < p_trinaryID                     & 2.5 < Lambdac_p_cms                    & 0.85 < p_p                    & 0.30 < pi_p                    & 4.0 > pi_p                    & 5.0 > p_p')
...
mass_plot_all_noStack(var='Lambdac_p_cms',
           ...
           myXlabel=r'$\Lambda_c$ momentum_cms ($\Lambda_c^+\to p^+ K^- \pi^+$) [GeV/c]', mylog=True)
...
mass_plot_all_noStack(var='p_trinaryID',
           ...
           myXlabel=r'proton trinaryID ($\Lambda_c^+\to p^+ K^- \pi^+$)', mylog=True)
...
mass_plot_all_noStack(var='K_binaryID',
           ...
           myXlabel=r'kaon binaryID ($\Lambda_c^+\to p^+ K^- \pi^+$)', mylog=True)


# In[26]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 2.5 < Lambdac_p_cms                    & 0.9 < p_trinaryID                    & 0.7 < K_binaryID')
...
mass_plot_all_noStack(var='Lambdac_flightDistance',
           ...
           myXlabel=r'$\Lambda_c$ flightDistance ($\Lambda_c^+\to p^+ K^- \pi^+$) [cm]', mylog=True)


# In[28]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.7 < K_binaryID                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance')


# In[29]:


mass_plot_all_noStack(var='Lambdac_significanceOfDistance',
           cuts='2.240 < Lambdac_M < 2.340',           
           nbins=100, myrange=(0,5.0),
           myXlabel=r'$\Lambda_c$ significanceOfDistance ($\Lambda_c^+\to p^+ K^- \pi^+$) [cm]', mylog=True)


# In[30]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.7 < K_binaryID                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance                    & 0.25 < Lambdac_significanceOfDistance')


# In[ ]:


mass_plot_all_noStack(var='pi_p',
           cuts='2.240 < Lambdac_M < 2.340',           
           nbins=100, myrange=(0,5.0),
           myXlabel=r'$\pi$ momentum ($\Lambda_c^+\to p^+ K^- \pi^+$) [GeV/c]', mylog=True)


# In[ ]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.7 < K_binaryID                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance                    & 0.25 < Lambdac_significanceOfDistance                    & 0.30 < pi_p')


# In[ ]:


mass_plot_all_noStack(var='p_p',
           cuts='2.240 < Lambdac_M < 2.340',           
           nbins=100, myrange=(0,5.0),
           myXlabel=r'proton momentum ($\Lambda_c^+\to p^+ K^- \pi^+$) [GeV/c]', mylog=True)


# In[ ]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.7 < K_binaryID                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance                    & 0.25 < Lambdac_significanceOfDistance                    & 0.30 < pi_p                    & 0.85 < p_p')
