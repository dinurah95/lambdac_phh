...
c_v_2 =['Lambdac_p_cms','Lambdac_flightDistance','p_trinaryID','K1_binaryID','K2_binaryID']


# In[4]:


Loading_cut = '2.240 < Lambdac_M & Lambdac_M < 2.340'
...
df_lam = read_root(lambda_c, key='lcp_pkk', columns=columns, where=Loading_cut) 
...
plotFom('Lambdac_p_cms', 
        ...
        100, 
        True, 
        r'$\Lambda_c$ momentum_cms ($\Lambda_c^+ \to p^+ K^+ K^-$)', 
...
plotFom('p_trinaryID', 
        ...
        100, 
        True, 
        r'proton trinaryID ($\Lambda_c^+ \to p^+ K^+ K^-$)', 
        cuts ='2.240 < Lambdac_M < 2.340\
                & 2.5 < Lambdac_p_cms')
...
plotFom('K1_binaryID', 
        ...
        100, 
        True, 
        r'kaon binaryID ($\Lambda_c^+ \to p^+ K^+ K^-$)', 
        cuts ='2.240 < Lambdac_M < 2.340\
                & 2.5 < Lambdac_p_cms\
                & 0.9 < p_trinaryID')
...
plotFom('Lambdac_flightDistance', 
        ...
        100, 
        True, 
        r'$\Lambda_c$ flightDistance ($\Lambda_c^+ \to p^+ K^+ K^-$)', 
        cuts ='2.240 < Lambdac_M < 2.340\
                & 0.9 < p_trinaryID\
                & 2.5 < Lambdac_p_cms\
                & 0.7 < K1_binaryID\
