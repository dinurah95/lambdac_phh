...
c_v_2 =['p_trinaryID','Lambdac_p_cms','Lambdac_flightDistance','Lambdac_significanceOfDistance','pi1_p','pi2_p','p_p']
...
df_lam = root_pandas.read_root(lambda_c, key='lcp_ppipi', columns=columns, where=Loading_cut) 
...
mass_plot_all_Stack(var='Lambdac_M',
           ...
           myXlabel=r'$\Lambda_c$ Mass ($\Lambda_c^+\to p^+ \pi^- \pi^+$) [GeV/$c^2$]', mylog=False)
...
get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                             & 0 < Lambdac_flightDistance                              & 0.25 < Lambdac_significanceOfDistance                             & 0.9 < p_trinaryID                             & 2.5 < Lambdac_p_cms                            & 0.30 < pi1_p                            & 0.30 < pi2_p                            & 0.85 < p_p')
...
mass_plot_all_noStack(var='Lambdac_p_cms',
           ...
           myXlabel=r'$\Lambda_c$ momentum_cms ($\Lambda_c^+\to p^+ \pi^- \pi^+$) [GeV/c]', mylog=True)
...
mass_plot_all_noStack(var='p_trinaryID',
           ...
           myXlabel=r'proton trinaryID ($\Lambda_c^+\to p^+ \pi^- \pi^+$)', mylog=True)
...
mass_plot_all_noStack(var='Lambdac_flightDistance',
           ...
           myXlabel=r'$\Lambda_c$ flightDistance ($\Lambda_c^+\to p^+ \pi^- \pi^+$) [cm]', mylog=True)


# In[24]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance')
...
mass_plot_all_noStack(var='Lambdac_significanceOfDistance',
           ...
           myXlabel=r'$\Lambda_c$ significanceOfDistance ($\Lambda_c^+\to p^+ \pi^- \pi^+$) [cm]', mylog=True)


# In[26]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance                    & 0.25 < Lambdac_significanceOfDistance')


# In[32]:


mass_plot_all_noStack(var='pi1_p',
           cuts='2.240 < Lambdac_M < 2.340',           
           nbins=100, myrange=(0,2),
           myXlabel=r'$\pi$ momentum ($\Lambda_c^+\to p^+ \pi^- \pi^+$) [GeV/C]', mylog=True)


# In[29]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance                    & 0.25 < Lambdac_significanceOfDistance                    & 0.3 < pi1_p                    & 0.3 < pi2_p')
...
mass_plot_all_noStack(var='p_p',
           cuts='2.240 < Lambdac_M < 2.340',           
           nbins=100, myrange=(0,2),
           myXlabel=r'proton momentum ($\Lambda_c^+\to p^+ \pi^- \pi^+$) [GeV/C]', mylog=True)


# In[31]:


get_purity_and_sigeff('Lambdac_M', '2.240 < Lambdac_M < 2.340                    & 0.9 < p_trinaryID                    & 2.5 < Lambdac_p_cms                    & 0 < Lambdac_flightDistance                    & 0.25 < Lambdac_significanceOfDistance                    & 0.3 < pi1_p                    & 0.3 < pi2_p                    & 0.85 < p_p')
