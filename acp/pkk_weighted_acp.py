...
ctrinfile = '/b2diska/dinura/rootfiles/ntuples/MC/lcp/weights/pkpi_pkk_weighted.root'


# %%
sigdf = root_pandas.read_root(siginfile, key='lcp_pkk', columns=col+mccol, where='Lambdac_M > 2.24 && Lambdac_M < 2.34')
...
# %%
plot_model(model=pdf_ext, mydata=data, nevents=int(data_size), mylabel=r'$\Lambda_c$ Mass ($\Lambda_c^+\rightarrow p K^- K^+$)  [GeV/$c^{2}$]', save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="signal_fit_signalchannel")
...
a1.floating = True
a2.floating = True
sig_yield.set_value(3000000)
sig_yield.floating = True
bkg_yield.set_value(10000000)
...
# %%
plot_model(model=pdf_ext, mydata=data, myrange=lcrange, nevents=int(data_size), mylabel=r'$\Lambda_c$ Mass ($\Lambda_c^+\rightarrow p K^- \pi^+$)  [GeV/$c^{2}$]', save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="intergrated_fit_controlchannel")
...
sig_sig_yield = zfit.Parameter('sig_sig_yield', 10000, 0, 1e5, step_size=1)
sig_bkg_yield = zfit.Parameter('sig_bkg_yield', 450000, 0, 1e6, step_size=1)
...
asig_sig_yield = zfit.Parameter('asig_sig_yield', 10000, 0, 1e5, step_size=1)
asig_bkg_yield = zfit.Parameter('asig_bkg_yield', 450000, 0, 1e6, step_size=1)
...
ctr_sig_yield = zfit.Parameter('ctr_sig_yield', 800000, 0, 1e6, step_size=1)
ctr_bkg_yield = zfit.Parameter('ctr_bkg_yield', 2500000, 0, 1e7, step_size=1)
...
actr_sig_yield = zfit.Parameter('actr_sig_yield', 800000, 0, 1e6, step_size=1)
actr_bkg_yield = zfit.Parameter('actr_bkg_yield', 2500000, 0, 1e7, step_size=1)
...
print('actr signal - not weighted: ' + str(len(actr_signal)))
print('actr bkg - not weighted: ' + str(len(actr_bkg)))
...
print("control component component completed:")
...
# %%
plot_model(model=sig_pdf_ext, mydata=sig_data, nevents=int(sig_data_size), mylabel=r'$\Lambda_c$ Mass ($\Lambda_{c}^{+}\rightarrow p K^- K^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="signalchannel_matter_bin1")


# %%
plot_model(model=asig_pdf_ext, mydata=asig_data, nevents=int(asig_data_size), mylabel=r'$\Lambda_c$ Mass ($\bar{\Lambda}_{c}^{-}\rightarrow \barp K^- K^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="signalchannel_antimatter_bin1")


# %%
plot_model(model=ctr_pdf_ext, mydata=ctr_data, nevents=int(ctr_data_size), mylabel=r'$\Lambda_c$ Mass ($\Lambda_{c}^{+}\rightarrow p K^- \pi^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="controlchannel_matter_bin1")


# %%
plot_model(model=actr_pdf_ext, mydata=actr_data, nevents=int(actr_data_size), mylabel=r'$\Lambda_c$ Mass ($\bar{\Lambda}_{c}^{-}\rightarrow \barp K^+ \pi^-$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="controlchannel_antimatter_bin1")
...
# %%
plot_model(model=sig_pdf_ext, mydata=sig_data, nevents=int(sig_data_size), mylabel=r'$\Lambda_c$ Mass ($\Lambda_{c}^{+}\rightarrow p K^- K^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="signalchannel_matter_bin2")


# %%
plot_model(model=asig_pdf_ext, mydata=asig_data, nevents=int(asig_data_size), mylabel=r'$\Lambda_c$ Mass ($\bar\Lambda_{c}^{-}\rightarrow \barp K^- K^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="signalchannel_antimatter_bin2")


# %%
plot_model(model=ctr_pdf_ext, mydata=ctr_data, nevents=int(ctr_data_size), mylabel=r'$\Lambda_c$ Mass ($\Lambda_{c}^{+}\rightarrow p K^- \pi^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="controlchannel_matter_bin2")


# %%
plot_model(model=actr_pdf_ext, mydata=actr_data, nevents=int(actr_data_size), mylabel=r'$\Lambda_c$ Mass ($\bar\Lambda_{c}^{-}\rightarrow \barp K^+ \pi^-$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/pkk/plots/", save_name="controlchannel_antimatter_bin2")
