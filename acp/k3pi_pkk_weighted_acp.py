...
dinfile = '/b2diska/dinura/rootfiles/ntuples/MC/dk3pi/weights/k3pi_pkk_weighted.root'
...
dsig_yield = zfit.Parameter('dsig_yield', 6000000, 0, 1e7, step_size=1)
dbkg_yield = zfit.Parameter('dbkg_yield', 25000000, 0, 1e8, step_size=1)
...
# %%
Dplot_model(model=dpdf_ext, mydata=data, myrange=(1.80,1.92), nevents=int(data_size), mylabel=r'$D^0$ Mass ($D^{0} \to K^- \pi^+ \pi^+ \pi^-$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/dk3pi/plots/weighted/", save_name="dk3pi_pkk_intergrated")
...
d_bkg_yield = zfit.Parameter('d_bkg_yield', 7000000, 0, 1e7, step_size=1)
...
ad_bkg_yield = zfit.Parameter('ad_bkg_yield', 7000000, 0, 1e7, step_size=1)
...
# %%
Dplot_model(model=d_pdf_ext, mydata=d_data, nevents=int(d_data_size), mylabel=r'$D^0$ Mass ($D^0\rightarrow K^- \pi^+ \pi^+ \pi^-$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/dk3pi/plots/weighted/", save_name="dk3pi_pkk_matter_bin1")


# %%
Dplot_model(model=ad_pdf_ext, mydata=ad_data, nevents=int(ad_data_size), mylabel=r'$D^0$ Mass ($\barD^0\rightarrow K^+ \pi^- \pi^- \pi^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/dk3pi/plots/weighted/", save_name="dk3pi_pkk_antimatter_bin1")
...
# %%
Dplot_model(model=d_pdf_ext, mydata=d_data, nevents=int(d_data_size), mylabel=r'$D^0$ Mass ($D^0\rightarrow K^- \pi^+ \pi^+ \pi^-$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/dk3pi/plots/weighted/", save_name="dk3pi_pkk_matter_bin2")


# %%
Dplot_model(model=ad_pdf_ext, mydata=ad_data, nevents=int(ad_data_size), mylabel=r'$D^0$ Mass ($\barD^0\rightarrow K^+ \pi^- \pi^- \pi^+$)  [GeV/$c^{2}$]', plot_data=True, save_dir="/b2diska/dinura/scripts/acp/py/dk3pi/plots/weighted/", save_name="dk3pi_pkk_antimatter_bin2")
