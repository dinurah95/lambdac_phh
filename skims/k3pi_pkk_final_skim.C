...
void Dk3pi_skim2 (TString input, TString output) {
...
// Define variables that need to take from the root file
  ...
  for (Long64_t iEntry(0); iEntry < nEntries; ++iEntry){
	 ...
	 //if ( rndm<=0.125  && 1.75 < M && M < 1.95)
	 if (eventRandom<0.0625 && 1.80<M && M<1.92 && K_binaryID>0.7 && K_p<4.0 && pi_1_p<4.0 && pi_2_p<4.0 && pi_3_p<4.0){
...
// root -l 'Dk3pi_skim2.C("/b2diska/dinura/rootfiles/ntuples/MC/k3pi_complete.root"","/b2diska/dinura/rootfiles/ntuples/MC/pkk_k3pi.root")'
