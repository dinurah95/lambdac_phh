...
void Dk3pi_skim1 (TString input, TString output) {
...
// Define variables that need to take from the root file
  ...
  for (Long64_t iEntry(0); iEntry < nEntries; ++iEntry){
	 ...
	 if (eventRandom<0.0625 && 1.80<M && M<1.92 && K_binaryID>0.7 && pi_1_p>0.30 && pi_2_p>0.30 && pi_3_p>0.30 && K_p<4.0 && pi_1_p<4.0 && pi_2_p<4.0 && pi_3_p<4.0){
...
// root -l 'Dk3pi_skim1.C("/b2diska/dinura/rootfiles/ntuples/MC/dk3pi/k3pi_complete.root","/b2diska/dinura/rootfiles/ntuples/MC/dk3pi/ppipi_k3pi.root")'
